...
public class RecipeDescriptionFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        generalRecipe = ((MainActivity) getActivity()).getSelectedGeneralRecipe();
        mRecipe = generalRecipe.getRecipe();
        ...
        if (recipeInformation != null){
            mReadyInMinutes.setText("Ready in " + String.valueOf(recipeInformation + " minutes."));
        }
